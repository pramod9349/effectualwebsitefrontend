              ...
              >
                <div className="md:mt-3 " style={{ padding: "10px" }}>
                  <p className=" text-gray-700 lg:text-4xl text-3xl font-extrabold leading-9">
                    Attorney Client Privilege & Work Product Doctrine – An
                    Analysis From Outsourcing Perspective
                  </p>
                </div>
...
export default AttorneyClientPrivilege;

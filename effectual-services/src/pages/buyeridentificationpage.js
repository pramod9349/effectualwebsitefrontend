          ...
          <div class="relative z-10 pb-8  sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full ">
            ...
            <main class="mx-auto max-w-5xl px-4 sm:mt-12 sm:px-6 md:mt-16  lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                <h1 class="px-12 text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
                  <span class="block xl:inline">Buyer 
                    <span class="block text-white xl:inline"> Identification</span> </span> 
                </h1>
              </div>
            </main>
          </div>

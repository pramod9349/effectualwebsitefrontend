            ...
            <section class="text-gray-600 px-16 body-font">
              <div class="container px-5 py-6 mx-auto">
                <div class="flex flex-wrap w-full mb-20">
                  ...
                  <p class=" w-full leading-relaxed text-gray-500 text-justify">Opportunity assessment gives insights into where there might be opportunities for technology to grow. While doing so Effectual can provide market insights, current industry trends, and focus on future growth opportunities that can add some value to the current business portfolio.</p>
                </div>
